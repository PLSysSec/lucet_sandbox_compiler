...
use lucet_module_wasmsbx::TrapSite;
...
// subtype.
fn translate_trapcode(code: ir::TrapCode) -> lucet_module_wasmsbx::TrapCode {
    match code {
        ir::TrapCode::StackOverflow => lucet_module_wasmsbx::TrapCode::StackOverflow,
        ir::TrapCode::HeapOutOfBounds => lucet_module_wasmsbx::TrapCode::HeapOutOfBounds,
        ir::TrapCode::OutOfBounds => lucet_module_wasmsbx::TrapCode::OutOfBounds,
        ir::TrapCode::IndirectCallToNull => lucet_module_wasmsbx::TrapCode::IndirectCallToNull,
        ir::TrapCode::BadSignature => lucet_module_wasmsbx::TrapCode::BadSignature,
        ir::TrapCode::IntegerOverflow => lucet_module_wasmsbx::TrapCode::IntegerOverflow,
        ir::TrapCode::IntegerDivisionByZero => lucet_module_wasmsbx::TrapCode::IntegerDivByZero,
        ir::TrapCode::BadConversionToInteger => lucet_module_wasmsbx::TrapCode::BadConversionToInteger,
        ir::TrapCode::Interrupt => lucet_module_wasmsbx::TrapCode::Interrupt,
        ir::TrapCode::TableOutOfBounds => lucet_module_wasmsbx::TrapCode::TableOutOfBounds,
        ir::TrapCode::UnreachableCodeReached => lucet_module_wasmsbx::TrapCode::Unreachable,
