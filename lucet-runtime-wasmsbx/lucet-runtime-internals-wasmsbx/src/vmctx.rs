...
use lucet_module_wasmsbx::{FunctionHandle, GlobalValue};
use std::any::Any;
...
impl Vmctx {
    ...
    ///
    /// ```no_run
    /// use lucet_runtime_internals_wasmsbx::{lucet_hostcalls, lucet_hostcall_terminate};
    /// use lucet_runtime_internals_wasmsbx::vmctx::{lucet_vmctx, Vmctx};
    ///
    /// lucet_hostcalls! {
    ///     #[no_mangle]
